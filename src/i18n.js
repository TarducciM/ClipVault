(function () {
  const DICTIONARY = {
    it: {
      ...
      updaterCheckBtn: "Cerca aggiornamenti",
      updaterAvailable: "Nuova versione disponibile: v{version}",
      updaterUpToDate: "Hai già l'ultima versione.",
      updaterUpdateNow: "Aggiorna ora",
      updaterDownloading: "Scaricamento in corso…",
      updaterDownloadingProgress: "Scaricamento in corso… {percent}%",
      updaterError: "Errore durante l'aggiornamento: {error}",
    ...
    en: {
      ...
      updaterAvailable: "New version available: v{version}",
      updaterUpToDate: "You're already on the latest version.",
      updaterUpdateNow: "Update now",
      updaterDownloading: "Downloading…",
      updaterDownloadingProgress: "Downloading… {percent}%",
