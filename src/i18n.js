(function () {
  const DICTIONARY = {
    it: {
      ...
      emptySnippetsTitle: "Nessuno snippet.",
      emptySnippetsSubtitle: "Scrivi qui sotto e premi Invio per salvarne uno.",
      ...
      snippetsTooltipOn: "Snippet (testi salvati a mano)",
      snippetsTooltipOff: "Torna alla cronologia",
      snippetsInputPlaceholder: "Nuovo snippet... (Invio per salvare)",
      contextCopy: "Copia",
      contextOpen: "Apri",
      contextOpenUrl: "Apri nel browser",
      contextComposeEmail: "Scrivi email",
      ...
      errorViewerOpen: "Impossibile aprire l'anteprima grande",
      ...
      settingsMaxFileLabel:
        "Dimensione massima file (MB, 0 = illimitato) — oltre non si salva l'immagine per intero, non si calcola SHA1/CRC32 e non si mostra l'anteprima del contenuto nell'anteprima file",
      ...
      settingsExport: "Esporta cronologia",
      settingsImport: "Importa cronologia",
      settingsExportSuccess: "Esportate {entries} voci e {snippets} snippet.",
      settingsImportSuccess: "Importate {entries} voci e {snippets} snippet.",
    },
    en: {
      ...
      emptySnippetsTitle: "No snippets yet.",
      emptySnippetsSubtitle: "Type below and press Enter to save one.",
      ...
      snippetsTooltipOn: "Snippets (hand-saved text)",
      snippetsTooltipOff: "Back to history",
      snippetsInputPlaceholder: "New snippet... (Enter to save)",
      contextCopy: "Copy",
      contextOpen: "Open",
      contextOpenUrl: "Open in browser",
      contextComposeEmail: "Compose email",
      ...
      errorViewerOpen: "Couldn't open the large preview",
      ...
      settingsMaxFileLabel:
        "Max file size (MB, 0 = unlimited) — above this, images aren't saved in full, SHA1/CRC32 aren't computed, and no content preview is shown in the file preview",
      ...
      settingsImport: "Import history",
      settingsExportSuccess: "Exported {entries} entries and {snippets} snippets.",
      settingsImportSuccess: "Imported {entries} entries and {snippets} snippets.",
    },
  };
